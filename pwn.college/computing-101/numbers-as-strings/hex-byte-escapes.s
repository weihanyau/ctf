...
backslash:
	...
	je  double_backslash
	cmp byte ptr [rsi + 1], 0x78 # check 'x'
	je  backslash_x
	jmp write_byte
...
percentage:
	...
	cmp byte ptr [rsi + 1], 0x64 # check '%d'
	je  percentage_digit
	cmp byte ptr [rsi + 1], 0x73
	je  percentage_s
	jmp write_byte
...
percentage_s_count_byte:
	cmp byte ptr [rsi + rdx], 0
	je  percentage_s_write_byte
	inc rdx
	jmp percentage_s_count_byte

percentage_s_write_byte:
	mov rax, 1
	mov rdi, 1
	syscall
	pop rdx
